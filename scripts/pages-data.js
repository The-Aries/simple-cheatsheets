(function () {
  ...
  var gitPage = {
    slug: "git",
    meta: { title: "Git Cheatsheet - Simple Cheatsheets", lang: "zh-CN" },
  ...
  window.CHEATSHEET_TEMPLATE_PAGES = {
    git: gitPage,
    linux: makeUnderConstructionPage("linux", "Linux"),
    markdown: makeUnderConstructionPage("markdown", "Markdown"),
    regex: makeUnderConstructionPage("regex", "Regex"),
    matlab: makeUnderConstructionPage("matlab", "MATLAB")
  };
})();
